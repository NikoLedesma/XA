...
void enviarDato(void* dato,size_t  tamanioDeDato,int socketDeComunicacion, int TipoDeDato ){
	...
	void *buffer=malloc((tamanioDeDato)+lengthReal);
	memcpy(buffer,tamanioDeDato,sizeof(int));
